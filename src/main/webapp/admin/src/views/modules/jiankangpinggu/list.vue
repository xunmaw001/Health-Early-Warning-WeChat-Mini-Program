  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="评估情况" prop="pingguqingkuang">
		  <el-select  @change="pingguqingkuangChange" clearable v-model="searchForm.pingguqingkuang" placeholder="请选择评估情况">
		    <el-option
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="姓名">
		     <template slot-scope="scope">
                ...
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign" 
                    prop="pingguqingkuang"
                   :header-align="contents.tableAlign"
		    label="评估情况">
		     <template slot-scope="scope">
                       {{scope.row.pingguqingkuang}}
                     </template>
                </el-table-column>
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="pinggutupian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="评估图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.pinggutupian">
                        <img :src="$base.url+scope.row.pinggutupian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.pingguqingkuang!='' && this.searchForm.pingguqingkuang!=undefined){
