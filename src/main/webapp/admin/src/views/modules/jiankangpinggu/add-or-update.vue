<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="评估情况" prop="pingguqingkuang">
          <el-select :disabled="ro.pingguqingkuang" v-model="ruleForm.pingguqingkuang" placeholder="请选择评估情况">
            <el-option
                v-for="(item,index) in pingguqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="评估情况" prop="pingguqingkuang">
	      <el-input v-model="ruleForm.pingguqingkuang"
                placeholder="评估情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.pinggutupian" label="评估图片" prop="pinggutupian">
          <file-upload
          tip="点击上传评估图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.pinggutupian" label="评估图片" prop="pinggutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.pinggutupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="评估内容" prop="pingguneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.pingguneirong" label="评估内容" prop="pingguneirong">
                    <span>{{ruleForm.pingguneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
