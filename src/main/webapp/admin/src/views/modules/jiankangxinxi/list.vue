  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="运动习惯" prop="yundongxiguan">
		  <el-select  @change="yundongxiguanChange" clearable v-model="searchForm.yundongxiguan" placeholder="请选择运动习惯">
		    <el-option
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('jiankangxinxi','评估') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="jiankangpingguCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复操作！')">{{ contents.tableBtnFont == 1?'评估':'' }}</el-button>
                <el-button v-if="isAuth('jiankangxinxi','评估') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="jiankangpingguCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复操作！')">{{ contents.tableBtnFont == 1?'评估':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('jiankangxinxi','评估') && contents.tableBtnIcon == 0" type="success" size="mini" @click="jiankangpingguCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复操作！')">{{ contents.tableBtnFont == 1?'评估':'' }}</el-button>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.yundongxiguan!='' && this.searchForm.yundongxiguan!=undefined){
