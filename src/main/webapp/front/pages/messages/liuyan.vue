	...
	<view class="content my-publish-pv">
		<form>
			...
			<view class="cu-form-group">
				...
				<textarea :style='{"padding":"20rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"rgba(71, 177, 60, 1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","borderRadius":"0","borderWidth":"2rpx","width":"100%","fontSize":"28rpx","borderStyle":"dashed ","height":"300rpx"}' v-model="ruleForm.content" placeholder="留言内容"></textarea>
			</view>
			...
			<view class="cu-form-group" style="text-align:center">
				<button :style='{"padding":"0 20rpx","boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","margin":"20rpx 0","borderColor":"rgba(71, 177, 60, 1)","backgroundColor":"rgba(71, 177, 60, 1)","color":"#fff","borderRadius":"80rpx","borderWidth":"1","width":"320rpx","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">提交</button>
			</view>
		</form>
	</view>
</template>
