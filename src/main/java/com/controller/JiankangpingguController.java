...
public class JiankangpingguController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiankangpingguEntity jiankangpinggu, 
		...
		if(tableName.equals("yonghu")) {
			jiankangpinggu.setYonghuming((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yisheng")) {
			jiankangpinggu.setYishenggonghao((String)request.getSession().getAttribute("username"));
		}
